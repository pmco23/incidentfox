...
INTEGRATION_LOGOS = {
    ...
    "splunk": f"{ASSETS_BASE_URL}/integrations/splunk.png?v=4",
    ...
    "newrelic": f"{ASSETS_BASE_URL}/integrations/new-relic.png?v=4",
    "new_relic": f"{ASSETS_BASE_URL}/integrations/new-relic.png?v=4",
    ...
    "github": f"{ASSETS_BASE_URL}/integrations/github.png?v=4",
