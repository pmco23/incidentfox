#!/usr/bin/env python3
"""
IncidentFox Agent Performance Evaluation
...
Usage:
    ...
    python3 scripts/run_agent_eval.py --agent-url http://agent.incidentfox.internal:8080
...
def main():
    ...
    try:
        ...
        print(
            "For local testing, run: kubectl port-forward svc/incidentfox-agent 8080:8080"
        )
        sys.exit(1)
