...
Hierarchical configuration management for IncidentFox agents and teams.
...
- `OIDC_ADMIN_GROUP` (default: `incidentfox-config-admin`)
...
export ADMIN_GROUP_PERMISSIONS_JSON='{"incidentfox-admins":["admin:*"],"incidentfox-ops":["admin:agent:run"]}'
```
