...
INTEGRATION_SCHEMAS = [
    {
        ...
        "featured": True,
        "fields": [
            {"name": "account", "type": "string", "required": True, "level": "org",
             "description": "Snowflake account identifier (e.g., xy12345.us-east-1)",
             "placeholder": "xy12345.us-east-1"},
            {"name": "user", "type": "string", "required": True, "level": "org",
             "description": "Snowflake username"},
            {"name": "password", "type": "secret", "required": True, "level": "org",
             "description": "Snowflake password"},
            {"name": "warehouse", "type": "string", "required": True, "level": "org",
             "description": "Default warehouse to use", "placeholder": "COMPUTE_WH"},
            {"name": "database", "type": "string", "required": False, "level": "team",
             "description": "Default database (team can override)"},
            {"name": "schema", "type": "string", "required": False, "level": "team",
             "description": "Default schema (team can override)", "default_value": "PUBLIC"},
            {"name": "role", "type": "string", "required": False, "level": "org",
    ...
    },
    {
        ...
        "featured": True,
        "fields": [
            {"name": "access_key_id", "type": "secret", "required": False, "level": "org",
             "description": "AWS Access Key ID (optional if using IAM roles)"},
            {"name": "secret_access_key", "type": "secret", "required": False, "level": "org",
             "description": "AWS Secret Access Key (optional if using IAM roles)"},
            {"name": "region", "type": "string", "required": True, "level": "org",
             "description": "Default AWS region", "default_value": "us-east-1"},
            {"name": "role_arn", "type": "string", "required": False, "level": "org",
             "description": "IAM Role ARN to assume (for cross-account access)"},
            {"name": "session_token", "type": "secret", "required": False, "level": "org",
    ...
    },
    {
        ...
        "featured": False,
        "fields": [
            {"name": "auth_token", "type": "secret", "required": True, "level": "org",
             "description": "Sentry Auth Token with project:read and issue:read scopes"},
            {"name": "organization", "type": "string", "required": True, "level": "org",
             "description": "Sentry organization slug"},
            {"name": "project", "type": "string", "required": False, "level": "team",
             "description": "Default project slug (team can override)"},
            {"name": "base_url", "type": "string", "required": False, "level": "org",
             "description": "Sentry API base URL (for self-hosted)", "default_value": "https://sentry.io/api/0"},
        ],
    },
    {
        "id": "splunk",
        ...
        "featured": False,
        "fields": [
            {"name": "host", "type": "string", "required": True, "level": "org",
             "description": "Splunk server hostname", "placeholder": "splunk.company.com"},
            {"name": "port", "type": "integer", "required": False, "level": "org",
             "description": "Splunk REST API port", "default_value": 8089},
            {"name": "token", "type": "secret", "required": True, "level": "org",
             "description": "Splunk authentication token"},
            {"name": "index", "type": "string", "required": False, "level": "team",
             "description": "Default index to search"},
            {"name": "verify_ssl", "type": "boolean", "required": False, "level": "org",
             "description": "Verify SSL certificates", "default_value": True},
        ],
    },
    {
        "id": "jira",
        ...
        "featured": False,
        "fields": [
            {"name": "url", "type": "string", "required": True, "level": "org",
             "description": "Jira instance URL", "placeholder": "https://company.atlassian.net"},
            {"name": "email", "type": "string", "required": True, "level": "org",
             "description": "Jira account email"},
            {"name": "api_token", "type": "secret", "required": True, "level": "org",
             "description": "Jira API token"},
            {"name": "project_key", "type": "string", "required": False, "level": "team",
    ...
    },
    {
        ...
        "featured": False,
        "fields": [
            {"name": "url", "type": "string", "required": False, "level": "org",
             "description": "GitLab instance URL", "default_value": "https://gitlab.com"},
            {"name": "token", "type": "secret", "required": True, "level": "org",
             "description": "GitLab personal access token with api scope"},
            {"name": "default_project", "type": "string", "required": False, "level": "team",
    ...
    },
    {
        ...
        "fields": [
            ...
            {"name": "team_id", "type": "string", "required": False, "level": "team",
    ...
    },
    {
        ...
        "fields": [
            ...
            {"name": "default_database_id", "type": "string", "required": False, "level": "team",
    ...
    },
    {
        ...
        "featured": False,
        "fields": [
            {"name": "webhook_url", "type": "secret", "required": True, "level": "team",
             "description": "Teams Incoming Webhook URL"},
            {"name": "tenant_id", "type": "string", "required": False, "level": "org",
             "description": "Azure AD Tenant ID (for Graph API)"},
            {"name": "client_id", "type": "string", "required": False, "level": "org",
             "description": "Azure AD App Client ID"},
            {"name": "client_secret", "type": "secret", "required": False, "level": "org",
    ...
    },
    {
        ...
        "fields": [
            {"name": "url", "type": "string", "required": True, "level": "org",
             "description": "Elasticsearch URL", "placeholder": "https://elasticsearch:9200"},
            {"name": "api_key", "type": "secret", "required": False, "level": "org",
             "description": "Elasticsearch API key (optional if using basic auth)"},
            {"name": "username", "type": "string", "required": False, "level": "org",
             "description": "Elasticsearch username"},
            {"name": "password", "type": "secret", "required": False, "level": "org",
             "description": "Elasticsearch password"},
            {"name": "index_pattern", "type": "string", "required": False, "level": "team",
             "description": "Default index pattern", "default_value": "logs-*"},
            {"name": "verify_ssl", "type": "boolean", "required": False, "level": "org",
             "description": "Verify SSL certificates", "default_value": True},
        ],
    },
    {
        ...
        "fields": [
            {"name": "url", "type": "string", "required": True, "level": "org",
             "description": "Confluence instance URL", "placeholder": "https://company.atlassian.net/wiki"},
            {"name": "email", "type": "string", "required": True, "level": "org",
             "description": "Confluence account email"},
            {"name": "api_token", "type": "secret", "required": True, "level": "org",
             "description": "Confluence API token"},
            {"name": "space_key", "type": "string", "required": False, "level": "team",
