...
variable "project" {
  ...
  default     = "incidentfox-config-service"
}
...
variable "token_pepper_secret_name" {
  ...
  default     = "incidentfox-config-service/token_pepper"
}
