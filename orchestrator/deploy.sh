...
# Deployment script for Orchestrator

AWS_REGION="${AWS_REGION:-us-west-2}"
AWS_PROFILE="${AWS_PROFILE:-playground}"
ECR_REPOSITORY="incidentfox-orchestrator"
...
docker build --platform linux/amd64 -f orchestrator/Dockerfile -t $ECR_REPOSITORY:latest orchestrator
