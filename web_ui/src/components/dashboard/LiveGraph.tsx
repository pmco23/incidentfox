...
export function LiveGraph() {
  ...
  useEffect(() => {
    ...
    const load = async () => {
      try {
        ...
        const orgId = (typeof window !== 'undefined' && (window.localStorage.getItem('incidentfox_org_id') || 'org1')) || 'org1';
  ...
  return (
    <div className="w-full h-[500px] bg-gray-50 dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 overflow-hidden">
      <ReactFlow
        nodes={nodes}
        edges={edges}
      ...
      >
        ...
        />
        <Controls className="!bg-white dark:!bg-gray-900 !border-gray-200 dark:!border-gray-800 !shadow-sm" />
        <Background variant={BackgroundVariant.Dots} gap={12} size={1} />
        
        <Panel position="top-left" className="bg-white/80 dark:bg-gray-900/80 backdrop-blur p-2 rounded-lg border border-gray-200 dark:border-gray-800 shadow-sm">
            ...
            {backendError && (
              <div className="mt-1 text-[10px] text-gray-500 max-w-[240px] truncate" title={backendError}>
