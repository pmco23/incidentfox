  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center py-8">
        ...
        <span className="ml-2 text-gray-500">Loading trees...</span>
      </div>
    );
  }
  ...
  if (trees.length === 0) {
    return (
      <div className="bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl p-8 text-center">
        <p className="text-gray-500">No knowledge trees configured.</p>
      ...
      <div className="flex items-center justify-between">
        ...
        {onCreateTree && (
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 text-sm bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors"
          >
