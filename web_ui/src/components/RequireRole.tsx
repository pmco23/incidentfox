...
export function RequireRole({
    ...
    return (
      <div className="p-8">
        <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 shadow-sm p-6">
          <div className="text-sm font-semibold text-gray-900 dark:text-white">Checking access…</div>
  ...
  if (!identity) {
    return (
      <div className="p-8">
        <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 shadow-sm p-6 space-y-2">
          <div className="text-sm font-semibold text-gray-900 dark:text-white">Sign-in required</div>
  ...
  if (identity.role !== role) {
    return (
      <div className="p-8">
        <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 shadow-sm p-6 space-y-2">
          <div className="text-sm font-semibold text-gray-900 dark:text-white">Not authorized</div>
          <div className="text-sm text-gray-600 dark:text-gray-300">
