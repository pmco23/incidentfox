...
variable "ecs_cluster_name" {
  ...
  default     = "incidentfox-config-service-cluster"
}
...
variable "config_service_url" {
  ...
  default = "http://internal-incidentfox-config-serv-internal-2010257803.us-west-2.elb.amazonaws.com"
}
